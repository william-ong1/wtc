  ...
  return (
    <div className="flex flex-col flex-1 items-center w-full lg:w-3/4 h-full py-4 lg:py-8 px-6 lg:px-12 gap-8 fade-in">
      ...
      <section 
        ...
        <h1 className="text-xl lg:text-2xl font-bold animate-gradient-text"> About Us </h1>
      ...
      <section 
        ...
        className={`flex flex-col items-center text-center w-full lg:w-3/4 gap-2 lg:gap-4 transition-all duration-700 ease-out ${ howItWorksSectionVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10' }`}>
        <h1 className="text-xl lg:text-2xl font-bold animate-gradient-text"> How It Works </h1>
        <div ref={featureCardsRef} className="grid md:grid-cols-3 gap-6 mt-2 w-4/5" >
      ...
      {/* CTA */}
      <section ref={ctaSectionRef} className={`flex flex-col items-center text-center w-full lg:w-3/4 gap-2 lg:gap-4 mb-4 mt-2 transition-all duration-700 ease-out ${ ctaSectionVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10' }`}>
        <h1 className="text-xl lg:text-2xl font-bold animate-gradient-text"> Ready to Identify A Car? </h1>
        <Link href="/" className="inline-block px-6 py-3 rounded-2xl text-white text-sm lg:text-base font-semibold bg-[#3B03FF]/80 transition-all duration-300 ease-in-out transform cursor-pointer hover:scale-105 shadow-lg hover:shadow-blue-500/20">
          Try It Now!
        </Link>
      </section>
