  ...
  return (
    ...
    >
      ...
      >
        ...
        {error && (
          <div className="bg-red-500/20 border border-red-500/50 text-red-200 p-3 rounded-xl mb-4 animate-fadeIn">
            {error}
          </div>
        )}

        {successMessage && (
          <div className="bg-green-500/20 border border-green-500/50 text-green-200 p-3 rounded-xl mb-4 animate-fadeIn">
            {successMessage}
          </div>
        )}
